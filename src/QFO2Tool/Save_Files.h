...
//char* Save_FRM_SDL(Surface *f_surface, struct user_info* user_info);
...
char* Save_IMG_BMP(Surface *b_surface, struct user_info* user_info);
void Save_Full_MSK_OpenGL(image_data* img_data, user_info* usr_info);

//void Save_FRM_tiles_SDL(Surface *PAL_surface, struct user_info* user_info);
...
//void Split_to_Tiles_SDL(Surface *surface, struct user_info* user_info, img_type type, FRM_Header* FRM_Header);
